            ...
            <div style="position:absolute;inset:0;display:flex;align-items:center;{{ $i % 2 === 1 ? 'justify-content:flex-end;' : '' }}">
              <div class="wrap" style="width:100%;">
                <div style="max-width:480px;color:#fff;{{ $i % 2 === 1 ? 'margin-left:auto;text-align:right;' : '' }}">
                  <p class="eyebrow" style="color:rgba(184,152,110,0.9);margin-bottom:20px;">{{ $slide['eyebrow'] }}</p>
                  ...
                  <div style="display:flex;flex-wrap:wrap;gap:14px;{{ $i % 2 === 1 ? 'justify-content:flex-end;' : '' }}">
                    @if(!empty($slide['button_text']))
                      <a href="{{ $slide['button_url'] ?: route('collection') }}" class="btn-white">{{ $slide['button_text'] }}</a>
                    @endif
  ...
  <div class="wrap">
    <div class="grid-cats">
      @foreach($categories as $category)
        <a href="{{ route('collection', ['category'=>$category->slug]) }}" class="cat-pill">
...
<section style="padding:32px 0;">
  <div class="wrap">
    <div class="dual-banner">
      ...
      <a href="{{ route('collection') }}" class="banner-card" style="aspect-ratio:4/3;">
        <img src="https://images.unsplash.com/photo-1617627143750-d86bc21e42bb?w=900&q=80&auto=format&fit=crop" alt="Sarees" style="height:480px;">
        ...
        <div class="banner-card-content">
          <p class="eyebrow" style="margin-bottom:8px;">New Season</p>
          <h3 style="font-family:'Cormorant Garamond',serif;font-size:2.5rem;font-style:italic;font-weight:300;margin-bottom:16px;">Saree Glow</h3>
      ...
      <div class="dual-right">
        <a href="{{ route('collection') }}" class="banner-card">
          <img src="https://images.unsplash.com/photo-1551488831-00ddcb6c6bd3?w=900&q=80&auto=format&fit=crop" alt="Co-ords" style="height:224px;object-position:top;">
          ...
          <div style="position:absolute;inset:0;display:flex;align-items:center;padding:32px;color:#fff;">
            <div>
              <p class="eyebrow" style="margin-bottom:6px;">Trending</p>
              <h3 style="font-family:'Cormorant Garamond',serif;font-size:2rem;font-style:italic;font-weight:300;">Co-ord Sets</h3>
            </div>
          </div>
        </a>
        <a href="{{ route('collection') }}" class="banner-card">
          <img src="https://images.unsplash.com/photo-1610030469983-98e550d6193c?w=900&q=80&auto=format&fit=crop" alt="Kurtas" style="height:224px;">
          <div class="banner-card-overlay" style="background:linear-gradient(to right,rgba(24,24,24,0.65),transparent);"></div>
          <div style="position:absolute;inset:0;display:flex;align-items:center;padding:32px;color:#fff;">
            <div>
              <p class="eyebrow" style="margin-bottom:6px;">Most Loved</p>
              <h3 style="font-family:'Cormorant Garamond',serif;font-size:2rem;font-style:italic;font-weight:300;">Kurta Sets</h3>
            </div>
          </div>
        </a>
      </div>
  ...
  <div class="wrap">
    <div style="display:flex;align-items:flex-end;justify-content:space-between;margin-bottom:32px;">
      ...
      <div style="display:flex;align-items:center;gap:12px;">
        <button class="arr-prev" style="width:40px;height:40px;border:1px solid #e5e5e5;background:none;cursor:pointer;display:flex;align-items:center;justify-content:center;transition:border-color 0.2s,color 0.2s;" onmouseover="this.style.borderColor='var(--secondary)';this.style.color='var(--secondary)'" onmouseout="this.style.borderColor='#e5e5e5';this.style.color='inherit'">
          <svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path d="M15.75 19.5L8.25 12l7.5-7.5"/></svg>
        </button>
        <button class="arr-next" style="width:40px;height:40px;border:1px solid #e5e5e5;background:none;cursor:pointer;display:flex;align-items:center;justify-content:center;transition:border-color 0.2s,color 0.2s;" onmouseover="this.style.borderColor='var(--secondary)';this.style.color='var(--secondary)'" onmouseout="this.style.borderColor='#e5e5e5';this.style.color='inherit'">
          <svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path d="M8.25 4.5l7.5 7.5-7.5 7.5"/></svg>
        </button>
        <a href="{{ route('collection') }}" style="font-size:11px;font-weight:700;letter-spacing:0.25em;text-transform:uppercase;color:var(--secondary);display:none;" id="arr-view-all">View All →</a>
      </div>
    </div>
    <div class="swiper arrivals-swiper" style="overflow:hidden;">
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide" style="width:240px;">
          <div class="pcard">
            <div class="pcard-img">
              ...
              @endif
              <button class="pcard-wish"><svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12z"/></svg></button>
              <a href="{{ route('product.show', $product['slug']) }}" class="pcard-quick">Add to Cart</a>
            </div>
            <div style="margin-top:14px;">
              <h3 style="font-size:13px;font-weight:600;line-height:1.4;margin-bottom:6px;">{{ $product['name'] }}</h3>
...
<div class="promo-banner">
  <img src="https://images.unsplash.com/photo-1483985988355-763728e1935b?w=1920&q=80&auto=format&fit=crop" alt="Sale">
  <div class="promo-overlay">
    <div class="promo-inner">
      <p class="eyebrow" style="margin-bottom:20px;">Limited Time</p>
      <h2 style="font-family:'Cormorant Garamond',serif;font-size:clamp(2.5rem,6vw,5.5rem);font-weight:300;font-style:italic;line-height:0.9;margin-bottom:32px;">Up to 40% Off<br>Bestsellers</h2>
      <a href="{{ route('collection') }}" class="btn-white">Shop the Sale</a>
    </div>
  </div>
</div>
...
<section style="padding:56px 0;background:var(--silk);">
  <div class="wrap">
    <div style="display:flex;align-items:flex-end;justify-content:space-between;margin-bottom:32px;">
      ...
      <a href="{{ route('collection') }}" style="font-size:11px;font-weight:700;letter-spacing:0.25em;text-transform:uppercase;color:var(--secondary);" id="bs-view-all">View All →</a>
    </div>
    <div class="grid-4">
    ...
    <div style="margin-top:40px;text-align:center;">
      <a href="{{ route('collection') }}" class="btn-secondary">View All Bestsellers</a>
    </div>
  </div>
</section>
...
<section style="padding:64px 0;background:var(--primary);">
  <div class="wrap">
    <div style="display:flex;flex-wrap:wrap;align-items:center;justify-content:space-between;gap:32px;">
      <div style="color:#fff;">
        <p class="eyebrow" style="color:var(--secondary);margin-bottom:12px;">Stay Close</p>
        <h2 style="font-family:'Cormorant Garamond',serif;font-size:clamp(2rem,4vw,3rem);font-weight:300;font-style:italic;line-height:1.1;">Join the <em>Atelier</em></h2>
        <p style="color:rgba(255,255,255,0.5);margin-top:10px;font-size:13px;font-weight:300;">Early access, exclusive drops, editorial stories.</p>
      </div>
